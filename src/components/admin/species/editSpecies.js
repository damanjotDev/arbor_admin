...
import { editSpeciesData } from '../../../actions/species';
...
const EditSpecies = () => {
  const dispatch = useDispatch()
   ...
   const location = useLocation()
    ...
    const {specie,loader}=useSelector(({species})=>species)
    const [speciesData, setSpeciesData] = useState({
      commonName:specie?.commonName?specie?.commonName:"",
      scientificName:specie?.scientificName?specie?.scientificName:""
    })
    ...
    const handleSubmit =(e)=>{
      ...
      if(!speciesData.commonName ||!speciesData.scientificName){
        ...
        dispatch(editSpeciesData(speciesData, navigate, location))
      }
    }
